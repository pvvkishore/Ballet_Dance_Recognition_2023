...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  5 14:19:25 2022
...
x11_input = Input((59,59,1))
x21_input = Input((59,59,1))
x31_input = Input((59,59,1))
x11_shortcut = x11_input
x31_shortcut = x31_input
x11 = Conv2D(16,(1,1),(1,1),padding = 'valid')(x11_input)
x21 = Conv2D(16,(1,1),(1,1),padding = 'valid')(x21_input)
x31 = Conv2D(16,(1,1),(1,1),padding = 'valid')(x31_input)
x121 = Multiply()([x11,x21])
x1231 = Multiply()([x31,x121])
x41 = Conv2D(1,(1,1),(1,1),padding = 'valid')(x1231)
xf1 = Add()([x41,x11_input])
xf1 = Add()([xf1,x31_input])
xf1 = Conv2D(1,(3,3),(1,1),padding = 'valid')(xf1)
xf1 = Conv2D(1,(3,3),(1,1),padding = 'valid')(xf1)
...
history = model.fit([X_train,X1_train,X2_train,X3_train,X4_train,X5_train, X6_train], 
                    y_train, epochs = 150, 
                    batch_size = 32, verbose=1,
                    validation_data=([X_test,X1_test,X2_test, X3_test,X4_test,X5_test,X6_test],
                                     y_test))
...
preds = model.predict([image,image1,image2,image3,image4,image5,image6])      
i = np.argmax(preds[0])
print(i)
#%%
